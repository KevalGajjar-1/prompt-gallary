              ...
              <div className="space-y-2">
                ...
                <div className="space-y-4">
                  <div 
                    ...
                    className={`relative border-2 border-dashed rounded-xl p-6 text-center cursor-pointer transition-all duration-200 hover:border-primary/50 hover:bg-base-200/20 ${image ? 'border-base-300' : 'border-base-300/50'}`}
                  >
                    <input
                      type="file"
                      ref={fileInputRef}
                    ...
                    {imagePreview ? (
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="text-sm">
                          <p className="font-medium text-base-content">Upload an image</p>
